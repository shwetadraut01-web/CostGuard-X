...
def markdown_to_docx(md_filepath: str, docx_filepath: str, doc_title: str):
    ...
    for line in lines:
        ...
        if line.startswith("# "):
            ...
            r = p.add_run(line[2:].replace("**", "").replace("*", ""))
            r.font.name = 'Arial'
            r.font.size = Pt(10)
...
if __name__ == "__main__":
    ...
    md_file = r"C:\Users\hp\.gemini\antigravity\brain\ac9edb07-cd0d-4916-aaa0-885a81f4878a\CostGuard_X_Complete_Research_Paper_and_Workflow.md"
    docx_file = os.path.join(desktop_dir, "CostGuard_X_Complete_Research_Paper_and_Workflow.docx")
    markdown_to_docx(md_file, docx_file, "CostGuard-X Complete Research Paper & System Workflow")
